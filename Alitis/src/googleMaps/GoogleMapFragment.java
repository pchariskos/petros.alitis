...
import googleMaps.TouchableWrapper.UpdateMapAfterUserInterection;
...
public class GoogleMapFragment extends MapFragment implements
		...
		GooglePlayServicesClient.OnConnectionFailedListener, LocationListener, UpdateMapAfterUserInterection
{
	...
	public void onUpdateMapAfterUserInterection() {
		...
		Log.d(MAPFRAGMENT_TAG,
				"[onUpdateMapAfterUserInterection]:  Map is updating");
	}
	...
	public void onStart() {
		...
		try {
			// Connect the client.
			if (mGooglePlayServicesManager.servicesConnected()) {
